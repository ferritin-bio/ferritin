...
1. Core Protein Data Structures for efficient protein representation using the Stuct-of-Arrays style. [link](https://zachcp.github.io/ferritin/posts/20241029_first_post/)
...
Now that I was able to get my feet wet on a protein language model implementation, I am ready to return to the more architecturally challenging problem of {Protein/Ligand}-MPNN. This post will descrive a few of the challenges faced
...
calculating the occurrences of function calls in the code bases [here](https://github.com/dauparas/LigandMPNN) and [here](https://huggingface.co/chandar-lab/AMPLIFY_120M) and showing
...
assemble the model into my pre-existing code.  This is where I began to run into a number of issues related to Tensor dimension.
...
My initial model ran in 3 minutes; the  new model in 8 seconds! Okay, we can work with that.
...
not much to show. But I am satisfied with where the project has gotten and am impressed by Justas Dauparas and his collaborators on this implementation. There are still some hard bits ahead.
