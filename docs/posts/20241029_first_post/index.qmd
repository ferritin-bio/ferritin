...
// note heterogeneous data especially Strings
pub struct AtomInfo {
    pub resv: i32,
    pub chain: String,
    pub alt: String,
...
that most people just kind of roll their own - e.g. use vectors of homogenous data in their struct types and handle the index themselves. That's what
...
At least that's what the Rust world seems to indicate. We'll see.  One other thing I wanted is something simple
