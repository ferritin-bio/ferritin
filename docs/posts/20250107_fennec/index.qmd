...
Local Application for running protein language models on ones own hardware. **Kick the [tires here](https://github.com/ferritin-bio/fennec/releases/tag/app-v0.1.0-dev)!**
...
- can optionally adjsut decode temperature
...
Return predicted probabilites of sequences using masked sequence models ESM2 and AMPLIFY.

![](images/screen_07.png)



## Contact Map Predicition
