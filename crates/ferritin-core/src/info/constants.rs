...
#[rustfmt::skip]
#[allow(dead_code)]
pub(crate) fn default_distance_range(a: &str, b: &str) -> Option<(f32, f32)> {
    match (a, b) {
        // https://github.com/biotite-dev/biotite/blob/main/src/biotite/structure/bonds.pyx#L1341C1-L1389C1
        //               # Taken from Allen et al.
        //                 min   - 2*std     max   + 2*std
        ("B",  "C" ) => Some((1.556 - 2.0*0.015,  1.556 + 2.0*0.015)),
        ("BR", "C" ) => Some((1.875 - 2.0*0.029,  1.966 + 2.0*0.029)),
        ("BR", "O" ) => Some((1.581 - 2.0*0.007,  1.581 + 2.0*0.007)),
        ("C",  "C" ) => Some((1.174 - 2.0*0.011,  1.588 + 2.0*0.025)),
        ("C",  "CL") => Some((1.713 - 2.0*0.011,  1.849 + 2.0*0.011)),
        ("C",  "F" ) => Some((1.320 - 2.0*0.009,  1.428 + 2.0*0.009)),
        ("C",  "H" ) => Some((1.059 - 2.0*0.030,  1.099 + 2.0*0.007)),
        ("C",  "I" ) => Some((2.095 - 2.0*0.015,  2.162 + 2.0*0.015)),
        ("C",  "N" ) => Some((1.325 - 2.0*0.009,  1.552 + 2.0*0.023)),
        ("C",  "O" ) => Some((1.187 - 2.0*0.011,  1.477 + 2.0*0.008)),
        ("C",  "P" ) => Some((1.791 - 2.0*0.006,  1.855 + 2.0*0.019)),
        ("C",  "S" ) => Some((1.630 - 2.0*0.014,  1.863 + 2.0*0.015)),
        ("C",  "SE") => Some((1.893 - 2.0*0.013,  1.970 + 2.0*0.032)),
        ("C",  "SI") => Some((1.837 - 2.0*0.012,  1.888 + 2.0*0.023)),
        ("CL", "O" ) => Some((1.414 - 2.0*0.026,  1.414 + 2.0*0.026)),
        ("CL", "P" ) => Some((1.997 - 2.0*0.035,  2.008 + 2.0*0.035)),
        ("CL", "S" ) => Some((2.072 - 2.0*0.023,  2.072 + 2.0*0.023)),
        ("CL", "SI") => Some((2.072 - 2.0*0.009,  2.072 + 2.0*0.009)),
        ("F",  "N" ) => Some((1.406 - 2.0*0.016,  1.406 + 2.0*0.016)),
        ("F",  "P" ) => Some((1.495 - 2.0*0.016,  1.579 + 2.0*0.025)),
        ("F",  "S" ) => Some((1.640 - 2.0*0.011,  1.640 + 2.0*0.011)),
        ("F",  "SI") => Some((1.588 - 2.0*0.014,  1.694 + 2.0*0.013)),
        ("H",  "N" ) => Some((1.009 - 2.0*0.022,  1.033 + 2.0*0.022)),
        ("H",  "O" ) => Some((0.967 - 2.0*0.010,  1.015 + 2.0*0.017)),
        ("I",  "O" ) => Some((2.144 - 2.0*0.028,  2.144 + 2.0*0.028)),
        ("N",  "N" ) => Some((1.124 - 2.0*0.015,  1.454 + 2.0*0.021)),
        ("N",  "O" ) => Some((1.210 - 2.0*0.011,  1.463 + 2.0*0.012)),
        ("N",  "P" ) => Some((1.571 - 2.0*0.013,  1.697 + 2.0*0.015)),
        ("N",  "S" ) => Some((1.541 - 2.0*0.022,  1.710 + 2.0*0.019)),
        ("N",  "SI") => Some((1.711 - 2.0*0.019,  1.748 + 2.0*0.022)),
        ("O",  "P" ) => Some((1.449 - 2.0*0.007,  1.689 + 2.0*0.024)),
        ("O",  "S" ) => Some((1.423 - 2.0*0.008,  1.580 + 2.0*0.015)),
        ("O",  "SI") => Some((1.622 - 2.0*0.014,  1.680 + 2.0*0.008)),
        ("P",  "P" ) => Some((2.214 - 2.0*0.022,  2.214 + 2.0*0.022)),
        ("P",  "S" ) => Some((1.913 - 2.0*0.014,  1.954 + 2.0*0.005)),
        ("P",  "SE") => Some((2.093 - 2.0*0.019,  2.093 + 2.0*0.019)),
        ("P",  "SI") => Some((2.264 - 2.0*0.019,  2.264 + 2.0*0.019)),
        ("S",  "S" ) => Some((1.897 - 2.0*0.012,  2.070 + 2.0*0.022)),
        ("S",  "SE") => Some((2.193 - 2.0*0.015,  2.193 + 2.0*0.015)),
        ("S",  "SI") => Some((2.145 - 2.0*0.020,  2.145 + 2.0*0.020)),
        ("SE", "SE") => Some((2.340 - 2.0*0.024,  2.340 + 2.0*0.024)),
        ("SI", "SE") => Some((2.359 - 2.0*0.012,  2.359 + 2.0*0.012)),
        _ => None,
    }
}
