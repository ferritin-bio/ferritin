...
define_residues! {
    ...
    LYS: "LYS", 'K', 8,  [0.0, 0.0],
    LEU: "LEU", 'L', 9,  [0.0, 0.0],
    MET: "MET", 'M', 10, [0.0, 0.0],
    ASN: "ASN", 'N', 11, [0.0, 0.0],
    PRO: "PRO", 'P', 12, [0.0, 0.0],
    GLN: "GLN", 'Q', 13, [0.0, 0.0],
    ARG: "ARG", 'R', 14, [0.0, 1.0],
    SER: "SER", 'S', 15, [0.0, 0.0],
    THR: "THR", 'T', 16, [0.0, 0.0],
    VAL: "VAL", 'V', 17, [0.0, 0.0],
    TRP: "TRP", 'W', 18, [0.0, 0.0],
    TYR: "TYR", 'Y', 19, [0.0, 0.0],
